...
{
    [self.label setText:[NSString stringWithFormat:@"Selected index: %f", sender.index]];
}
...
{
    sender.selected = !sender.selected;
    [self.sliderView setTrackCircleImage:sender.selected ? [UIImage imageNamed:@"1"] : nil forState:UIControlStateNormal];
    [self.sliderView setTrackCircleImage:sender.selected ? [UIImage imageNamed:@"2"] : nil forState:UIControlStateSelected];
}
